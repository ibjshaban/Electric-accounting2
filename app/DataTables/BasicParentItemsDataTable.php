...
class BasicParentItemsDataTable extends DataTable
{
    ...
    {
        return BasicParentItem::query()->where('basic_id', $this->basic_id)->select("basic_parent_items.*");
            ...
            ->parameters([
                ...
                'buttons' => [
                    [
                        ...
                        'action'    => 'function(){
                        	window.location.basicparents =  "'.\URL::current().'/create";
                        }',
                    ],*/
                ],

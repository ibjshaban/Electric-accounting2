...
@section('content')
    ...
    <div class="card card-dark">
        <div class="card-header">
			...
			{{ !empty($title)?$title:'' }}
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a href="{{ aurl('debt') }}" style="color:#343a40" class="dropdown-item">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/debt'),'id'=>'debt','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::number('amount',old('amount'),['class'=>'form-control','placeholder'=>'المبلغ']) !!}
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">

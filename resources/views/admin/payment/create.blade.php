	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('payment') }}"  style="color:#343a40"  class="dropdown-item">
...
<form action="{{aurl('/payment')}}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="post" id="payment">
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::number('amount',old('amount'),['class'=>'form-control', 'step'=>'0.0001', 'placeholder'=> 'المبلغ']) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	<div class="form-group">

	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('payment/'.$payment->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$payment->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			@if(!empty($payment->admin_id()->first()))
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				<b>{{trans('admin.admin_id')}} :</b>
				{{ $payment->admin_id()->first()->name }}
			</div>
			@endif
				...
				@if(!empty($payment->supplier_id()->first()))
			{{ $payment->supplier_id()->first()->name }}
			@endif
			</div>

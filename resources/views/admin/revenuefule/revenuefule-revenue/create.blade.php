...
{!! Form::open(['url'=>aurl('/revenuefule-revenue/create/'.$revenueFule->id),'id'=>'revenuefule','files'=>true,'class'=>'form-horizontal form-row-seperated', 'method' => 'post']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	<div class="form-group">
		...
		{!! Form::select('stock_id',App\Models\Stock::where('city_id', $revenueCity)->pluck('name','id'),old('stock_id'),['class'=>'form-control select2','placeholder'=>trans('admin.choose')]) !!}
	</div>
</div>
{{--<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	<div class="form-group">

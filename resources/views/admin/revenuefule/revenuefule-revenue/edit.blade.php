...
{!! Form::open(['url'=>aurl('/revenuefule-revenue/edit/'.$revenueFule->id),'method'=>'put','id'=>'revenuefule','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
{!! Form::select('stock_id',App\Models\Stock::where('city_id', $revenueCity)->pluck('name','id'), $revenueFule->stock_id ,['class'=>'form-control select2']) !!}
		</div>
</div>
{{--
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">

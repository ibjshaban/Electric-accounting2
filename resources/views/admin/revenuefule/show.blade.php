	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('revenuefule/'.$revenuefule->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$revenuefule->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.quantity')}} :</b>
				{!! $revenuefule->quantity !!}
			</div>
				...
				<b>{{trans('admin.paid_amount')}} :</b>
				{!! $revenuefule->paid_amount !!}
			</div>
				...
				<b>{{trans('admin.filling_id')}} :</b>
				@if(!empty($revenuefule->filling_id()->first()))
			{{ $revenuefule->filling_id()->first()->name }}
			@endif
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.stock_id')}} :</b>
				@if(!empty($revenuefule->stock_id()->first()))
			{{ $revenuefule->stock_id()->first()->name }}
			@endif
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.revenue_id')}} :</b>
				@if(!empty($revenuefule->revenue_id()->first()))
			{{ $revenuefule->revenue_id()->first()->name }}
			@endif
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.city_id')}} :</b>
				@if(!empty($revenuefule->city_id()->first()))
			{{ $revenuefule->city_id()->first()->name }}
			@endif
			</div>

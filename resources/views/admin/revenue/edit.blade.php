	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('revenue/'.$revenue->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/revenue/'.$revenue->id),'method'=>'put','id'=>'revenue','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('name',trans('admin.name'),['class'=>'control-label']) !!}
        {!! Form::text('name', $revenue->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('total_amount',trans('admin.total_amount'),['class'=>'control-label']) !!}
        {!! Form::number('total_amount', $revenue->total_amount ,['class'=>'form-control','placeholder'=>trans('admin.total_amount')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <!-- Date range -->
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('open_date', $revenue->open_date ,['class'=>'form-control float-right datepicker','placeholder'=>trans('admin.open_date'),'readonly'=>'readonly']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('close_date', $revenue->close_date ,['class'=>'form-control float-right datepicker','placeholder'=>trans('admin.close_date'),'readonly'=>'readonly']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->

 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="{{ aurl('/generalrevenue/'.$id.'/edit')}}" class="dropdown-item" ><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
		<a href="{{ aurl('/generalrevenue/'.$id)}}" class="dropdown-item" ><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				{!! Form::open([
				'method' => 'DELETE',
				'route' => ['generalrevenue.destroy', $id]
				]) !!}

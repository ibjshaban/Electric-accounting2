            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="delete_done"><i class="fa fa-exclamation-triangle"></i>
                            {{ trans('admin.ask-delete') }} <span id="count"></span> {{ trans('admin.record') }} </div>

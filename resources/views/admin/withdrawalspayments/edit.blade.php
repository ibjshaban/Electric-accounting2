...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('name', $withdrawalspayments->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('price',trans('admin.price'),['class'=>' control-label']) !!}
        {!! Form::number('price',$withdrawalspayments->price,['class'=>'form-control','placeholder'=>'سعر(لتر)','step'=>"0.001",'min'=>"0",'id'=> 'filling_price','required'=>'required','oninput'=>'changeAllPrice(this)']) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <!-- Date range -->
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('date', $withdrawalspayments->date ,['class'=>'form-control float-right datepicker','placeholder'=>trans('admin.date'),'readonly'=>'readonly']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::textarea('note', $withdrawalspayments->note ,['class'=>'form-control','placeholder'=>trans('admin.note')]) !!}
    </div>
</div>
</div>
		<!-- /.row -->

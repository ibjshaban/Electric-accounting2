	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a data-toggle="modal" data-target="#deleteRecord{{$supplier->id}}" class="dropdown-item" style="color:#343a40" href="#">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}}  ({{$supplier->id}})
					</div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <input type="text" id="name" name="name" value="{{ $supplier->name }}" class="form-control" placeholder="{{trans('admin.name')}}" />
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">

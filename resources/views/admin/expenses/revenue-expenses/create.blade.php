	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('expenses') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/revenue-expenses/create/'.$expenses->id),'id'=>'expenses','files'=>true,'class'=>'form-horizontal form-row-seperated','method' => 'post']) !!}
<div class="row">

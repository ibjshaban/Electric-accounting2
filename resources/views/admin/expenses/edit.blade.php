...
@section('content')
    ...
    <div class="card card-dark">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/expenses/'.$expenses->id),'method'=>'put','id'=>'expenses','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('price', $expenses->price ,['class'=>'form-control','placeholder'=>trans('admin.price')]) !!}
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <!-- Date range -->
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('revenue_id',App\Models\revenue::pluck('name','id'), $expenses->revenue_id ,['class'=>'form-control select2','placeholder'=>trans('admin.revenue_id')]) !!}
                    </div>
                </div>

...
@section('content')
    ...
    <div class="card card-dark">
        <div class="card-header">
			...
			{{ !empty($title)?$title:'' }}
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a href="{{ aurl('notebooks') }}" style="color:#343a40" class="dropdown-item">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/notebooks'),'id'=>'notebooks','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        {!! Form::label('price',trans('admin.price'),['class'=>' control-label']) !!}
                        {!! Form::number('price',old('price'),['class'=>'form-control','step'=>'0.001','placeholder'=>trans('admin.price')]) !!}
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <!-- Date range -->

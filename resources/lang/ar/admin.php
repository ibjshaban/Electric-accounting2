<?php
		...
		"startup-items"	=>		"عناصر المصاريف الاساسية",
		"other-notebooks"	=>		"دفاتر اخرى",
		"rentals"	=>		"دفتر الايجارات",
		...
		"rememberme"	=>		"تذكرنى",
		"login"	=>		"دخول",
		"error_loggedin"	=>		"رقم الجوال او كلمة المرور غير صحيحة",
		"back"	=>		"للخلف",
		"reset"	=>		"إستعادة",
		"logout"	=>		"خروج",
		...
		"mobile_not_found"	=>		"هذا الجوال غير مسجل لدينا",
        ...
        "remainder"=>"الباقي",
        "log"=>" سجل العمليات",
        "logged"=> "تمت تنفيذ العملية و ستتم مراجعتها عند المسؤول",
        "log_details"=> "تفاصيل العملية"
